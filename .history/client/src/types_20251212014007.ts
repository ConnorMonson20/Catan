...
export type ClientMessage =
  ...
  | { type: 'setCustomBoard'; hexes: Array<{ id?: string; q: number; r: number; resource: ResourceType | 'desert'; numberToken?: number }>; ports?: Array<{ id?: string; vertexKey?: string; ratio: 2 | 3; resource?: ResourceType | 'any' }> }
